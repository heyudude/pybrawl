...
class ClanSearchResult(object):
    ...
    def __init__(self, items=None, paging=None):  # noqa: E501
        """ClanSearchResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this ClanSearchResult.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this ClanSearchResult.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClanSearchResult):
            return False

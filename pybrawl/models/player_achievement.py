...
class PlayerAchievement(object):
    ...
    def __init__(self, name=None, stars=None, value=None, target=None, info=None, local_vars_configuration=None):  # noqa: E501
        """PlayerAchievement - a model defined in OpenAPI"""  # noqa: E501

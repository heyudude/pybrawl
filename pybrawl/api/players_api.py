...
class PlayersApi(object):
    ...
    def get_player(self, player_tag, **kwargs):  # noqa: E501
        ...
        Get information about a single player by player tag. Player tags can be found either in game or by from club member lists. Note that player tags start with hash character '#' and that needs to be URL-encoded properly to work in URL, so for example player tag '#2ABC' would become '%232ABC' in the URL.   # noqa: E501
    ...
    def get_player_with_http_info(self, player_tag, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PlayerDetail, status_code(int), headers(HTTPHeaderDict))
        """
